...
class Choices(ADSMBase):
	...
	def main(self):
		...
		self.sync_to_list_by_comparison(Choices.choices_list, Choices.ref_view, '_ows_Title', rows(), 'Title', compare_f, field_map, content_type='Configuration Item Choice', commit=not self.args.d)
